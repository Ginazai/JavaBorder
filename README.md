...
<h2>Examples</h2>
<figure>
	<img src="https://github.com/Ginazai/JavaBorder/blob/main/examples/SampleImage.jpg" width="75%">
	<figcaption>Fig. 1: original image</figcaption>
</figure>
<figure>
	<img src="https://github.com/Ginazai/JavaBorder/blob/main/examples/SampleImage-copy(white%20border).jpg" width="75%">
	<figcaption>Fig. 2: white border square image</figcaption>
</figure>
<figure>
	<img src="https://github.com/Ginazai/JavaBorder/blob/main/examples/SampleImage-copy(black%20border).jpg" width="75%">
